...
function TwoButtonStack(props) {
  const { title1, onPress1, title2, onPress2 } = props;
  return (
    <View className="flex-col space-y-2">
      <TouchableOpacity
        onPress={onPress1}
        className="bg-primaryPurple h-12 w-52 pt-3 rounded-full mx-1.5"
      >
      ...
      <TouchableOpacity
        onPress={onPress2}
        className="bg-darkerPurple h-12 w-52 pt-3 rounded-full mx-1.5"
      >
