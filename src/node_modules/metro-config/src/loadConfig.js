...
function mergeConfig(defaultConfig, ...configs) {
  ...
  return configs.reduce((totalConfig, nextConfig) => {
    var _totalConfig$watcher,
      _nextConfig$watcher,
      _totalConfig$watcher2,
      _nextConfig$watcher2;
    ...
    return {
      ...
      watcher: {
        ...
        ...nextConfig.watcher,
        watchman: {
          ...((_totalConfig$watcher = totalConfig.watcher) === null ||
          _totalConfig$watcher === void 0
            ? void 0
            : _totalConfig$watcher.watchman),
          ...((_nextConfig$watcher = nextConfig.watcher) === null ||
          _nextConfig$watcher === void 0
            ? void 0
            : _nextConfig$watcher.watchman),
        },
        healthCheck: {
          ...((_totalConfig$watcher2 = totalConfig.watcher) === null ||
          _totalConfig$watcher2 === void 0
            ? void 0
            : _totalConfig$watcher2.healthCheck),
          // $FlowFixMe: Spreading shapes creates an explosion of union types
          ...((_nextConfig$watcher2 = nextConfig.watcher) === null ||
          _nextConfig$watcher2 === void 0
            ? void 0
            : _nextConfig$watcher2.healthCheck),
        },
      },
    };
  }, defaultConfig);
